...
# 🎯 Обновлено: 2025-12-16 на основе 8 baseline запусков
# 📊 Baseline P95: 55.6s (среднее из 8 нормальных запусков)
...
# 🎯 Обновлено: 2025-12-16 на основе 8 baseline запусков
# 📊 Baseline P95: 106.4s (среднее из 8 нормальных запусков)
# ✏️ Как изменить: замените на реальное значение P95 * 1.2
_metrics_collector.define_slo(
...
# 🎯 Обновлено: 2025-12-16 на основе 8 baseline запусков
# 📊 ВАЖНО: Метрика крайне нестабильна!
#    - Реальный P95: 1.3s
#    - Диапазон: 0.6s-8.4s (14× вариация!)
#    - Используем консервативный baseline: 2.5s (1.92× от реального P95)
#    - Эффективный множитель от реального P95: 2.31× (вместо стандартных 1.2×)
# ✏️ Обоснование: Высокая нестабильность требует мягкого порога
_metrics_collector.define_slo(
    name="dashboard_duration",      # Имя метрики (НЕ МЕНЯТЬ!)
    threshold=3.0,                   # Real P95 (1.3s) → Safe baseline (2.5s) × 1.2 = 3.0s
    comparison="less_than"           # Должно быть МЕНЬШЕ порога
)
...
# 🎯 Обновлено: 2025-12-16 на основе 8 baseline запусков
# 📊 Baseline P95: 68.2s (среднее из 8 нормальных запусков)
